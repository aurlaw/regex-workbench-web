  ...
  <div class="flex flex-col rounded-lg border border-gray-200 bg-white">
    <div class="flex items-center justify-between border-b border-gray-200 px-4 py-3">
      ...
      <button
        ...
        :class="allCopied ? 'bg-green-50 text-green-600' : 'text-gray-500 hover:bg-gray-100 hover:text-gray-700'"
      >
            ...
            <div class="min-w-0 flex-1">
              <div class="flex items-center gap-1.5">
                ...
                <button
                  ...
                  class="flex h-5 w-5 shrink-0 items-center justify-center rounded text-gray-300 transition-colors hover:text-gray-500"
                >
