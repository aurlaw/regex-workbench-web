...
const { user, isAuthenticated, isLoading, isConfigured, signInWithGitHub, signOut } = useAuth()

const avatarUrl = computed(() => user.value?.user_metadata?.avatar_url as string | undefined)
const username = computed(() => user.value?.user_metadata?.user_name as string | undefined)
</script>
